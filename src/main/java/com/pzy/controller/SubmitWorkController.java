 ...
 */
@Controller
@RequestMapping("/admin/submitwork")
public class SubmitWorkController {
	...
	public String create(Model model) {
		...
		return "admin/submitwork/create";
	}
	@RequestMapping("index")
	public String index() {
		return "admin/submitwork/index";
	}
	...
	public Map<String, Object> list(
		...
		Page<SubmitWork> users = submitworkService.findAll(pageNumber, pageSize, name);
