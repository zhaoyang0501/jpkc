...
public class KnowledgeController {
	...
	public String save( HttpServletRequest request,Knowledge knowledge,Model model,@RequestParam(value = "file", required = false) MultipartFile file) {
