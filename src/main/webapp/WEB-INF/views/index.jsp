      ...
      <section class="envor-section envor-home-slider">
        <div id="layerslider" class="envor-layerslider" style="height: 500px;">
          ...
          <div class="ls-layer" style="transition3d: 1,4,5,11; transition2d: 2,8,30;">
            ...
            <img class="ls-bg" src="img/bg1.png" alt="layer1-background">
          </div>
          <!--LayerSlider layer-->
        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-12">
              <h2>精品课程网站成立啦！</h2>
              <p>
            我们是一家移动互联网创业公司，我们是一支拥有丰富的互联网行业经验的创业团队，将重新定义在线教育观念。我们崇尚自由、不拘小节，我们关注用户、追求极致，我们充满激情、快速迭代，致力于为用户提供优质的用户体验。
              </p>
              <p>
