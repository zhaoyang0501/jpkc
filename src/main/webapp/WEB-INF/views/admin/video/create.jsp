				...
				<div class="row-fluid ">
					<div class="span12">
						<div class="content-widgets light-gray">
							...
							<form enctype="multipart/form-data" action="${pageContext.request.contextPath}/admin/video/create" method="post" id=''>
							
							<div class="control-group">
								<label for="title" class="control-label">视频文件：</label>
								<div class="controls">
